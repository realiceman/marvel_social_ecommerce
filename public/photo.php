...
//apr�s le process on retrouve les enregistrements de commentaires en bdd
...
<div style="margin-left:20px;">
   ...
   <p><?php echo $photo->caption; ?></p>
     ...
     <div id="comments" style="color:#4894ff;">
	   ...
	   <div class="comment" style="margin-bottom:2em;">
				  ...
				  <div class="body">
				  <?php echo strip_tags($comment->body, '<strong><em><p>'); ?><!-- ...et le commentaire avec des tags accord�s pour formater le texte -->
				  </div>
				  <div class="meta-info" stylee="font-size: 0.8em;">
				  <?php echo $comment->created ; ?> <!-- ....et la date de cr�ation -->
				  </div><br/>
			 <?php endforeach; ?>
 ...
 <div id="comment-form" style="color:white;">
    <h3>new comment</h3>
	   ...
	   <form action ="photo.php?id=<?php echo $photo->id; ?>" method="post"> <!--on revient � la meme page et meme photo avec l'id  -->
	   <table>
	     <tr>
