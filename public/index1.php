...
<head>  
		...
		<style>
		body {background-image:url('images/marveldc.jpg');no-repeat center center center;
  ...
  <?php 
    if($pagination->total_pages() > 1){
		...
		for($i=1; $i <= $pagination->total_pages(); $i++){
				...
				echo " <a href=\"index1.php?page={$i}\" style=\"text-decoration:none; color:white;font-family:gratis;\"> {$i}</a>" ;
			}	
