...
class User  {
  ...
  // methodes communes qui seront reutilisées ailleurs
	...
	public function create() {
	 ...
	 $sql .= "username, password, first_name, last_name"; //ttes les attributs de la table seront mis à la suite avec la virgule
	 $sql .=") VALUES ('";
	 $sql .= Stripslashes($this->username) ."', '";
	 $sql .= Stripslashes($this->password) ."', '";
	...
	$sql .= "username='". Stripslashes($this->username) ."', ";
